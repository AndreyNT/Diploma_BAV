...
class HtmlOutput:
    ...
    def generateTimeTable(solution, slot_table):
        ...
        for cc, reservation in items():
            ...
            for prof in cc.Professors:
                ...
                room_schedule[dayId] = "".join(getCourseClass(cc, solution._configuration.getRoomById(roomId).Name, solution.criteria, ci))
            ci += 6
    ...
    @staticmethod
    def getTableHeader(prof):
        sb = [
            "<tr><th style='border: .1em solid black' scope='col' colspan='2'>Professor: ",
            prof.Name,
            "</th>\n",
        ]
        ...
        sb.append("</tr>\n")
        sb.append("<tr>\n")
        sb.append("<th style='border: .1em solid black; padding: .25em'>Prof: ")
        sb.append("Yes" if prof.isProf else "No")
        sb.append("</th>\n")
        sb.append("</tr>\n")
        return "".join(str(v) for v in sb)